...
public class EmployeeReport extends JPanel {
	...
	public EmployeeReport(final JFrame currentGUIFrame,final SessionManager sessionManager) {
		setLayout(null);		
		...
		lblNewLabel = new JLabel("Employee Report");
		...
		Object columnNames[] = { "Client Name", "Project Name", "Employee Name", "Bill Rate"};
		final MyDatabaseHelper myDatabaseHelper=new MyDatabaseHelper();
		final ArrayList approveList=null;
		if(approveList!=null &&  approveList.size()!=0){			
		rowData=new String[ approveList.size()][4];
